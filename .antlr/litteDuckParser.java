// Generated from c:/JavLib/LittleDuck/litteDuck.g4 by ANTLR 4.13.1
...
public class litteDuckParser extends Parser {
	...
	public final ProgramaContext programa() throws RecognitionException {
		...
		try {
			...
			((ProgramaContext)getInvokingContext(0)).dirFunc.add((((ProgramaContext)_localctx).ID!=null?((ProgramaContext)_localctx).ID.getText():null));System.out.println("TOY VIVO JAJAJA");
			setState(83);
			match(T__1);
			setState(84);
			vars();
			...
			match(T__3);
			            ...
			            System.out.println("\n\nVARIABLES GLOBALES"+((ProgramaContext)getInvokingContext(0)).globalVar+"\n\n");
			            System.out.println("\n\nVARIABLES DIR_FUNCIONES"+((ProgramaContext)getInvokingContext(0)).dirFunc+"\n\n");
	...
	public final Md_funcsContext md_funcs() throws RecognitionException {
		...
		try {
			...
			((Md_funcsContext)_localctx).ID = match(ID);
			        ...
			        System.out.println("\n\nFUNCION: "+(((Md_funcsContext)_localctx).ID!=null?((Md_funcsContext)_localctx).ID.getText():null)+"\n");
